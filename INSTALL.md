...
In this way, you can set up an Alpine build environment in a chroot under a different Linux distro.
There's a script that simplifies this steps with just two commands, and can be found here https://github.com/alpinelinux/alpine-chroot-install.

Once the build environment is installed, you can setup the system to build the packages by following this document: https://wiki.alpinelinux.org/wiki/Creating_an_Alpine_package
