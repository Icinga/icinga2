...
private:
	...
	template<typename T>
	void Record(const Checkable::Ptr& checkable, const String& metric, T value, double startTime, double endTime, OTelAttrsMap&& attrs);
	...
	{
		std::map<String, Gauge::Ptr> Metrics;
		/**
