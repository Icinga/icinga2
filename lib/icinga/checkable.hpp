...
public:
	...
	static boost::signals2::signal<void (const Shared<RedundancyGroup>::Ptr&, const intrusive_ptr<Dependency>&)> OnRedundancyGroupMemberRemoved;
...
private:
	...
	std::unordered_map<String, Shared<RedundancyGroup>::Ptr> m_Dependencies;
