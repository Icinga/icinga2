...
Configuration Attributes:
  ...
  host\_tags\_template      | Dictionary            | **Optional.** Allows to apply additional tags to the Elasticsearch host entries. They will be added under `tags`. Defaults to an empty Dictionary.
  service\_tags\_template   | Dictionary            | **Optional.** Allows to apply additional tags to the Elasticsearch service entries. They will be added under `tags`. Defaults to an empty Dictionary.
