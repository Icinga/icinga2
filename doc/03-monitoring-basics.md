...
and service notifications by email via `mail` and `ssmtp`.
...
`mail-service-notification`, `ssmtp-host-notification` and
`ssmtp-service-notification` correspond to the shell scripts
`mail-host-notification.sh`, `mail-service-notification.sh`,
`ssmtp-host-notification.sh` and `ssmtp-service-notification.sh` in
...
> **Note**
>
> The ssmtp examples require the `ssmtp` binary installed and
> [configured](https://wiki.archlinux.org/index.php/SSMTP)
...
#### ssmtp-host-notification <a id="ssmtp-host-notification"></a>

The `ssmtp-host-notification` NotificationCommand object uses the
example notification script located in `/etc/icinga2/scripts/ssmtp-host-notification.sh`.
...
#### ssmtp-service-notification <a id="ssmtp-service-notification"></a>

The `ssmtp-service-notification` NotificationCommand object uses the
example notification script located in `/etc/icinga2/scripts/ssmtp-service-notification.sh`.
