...
send metrics independently to the configured OTLP backend. In order to avoid duplicate metrics being sent from
...
metrics to the configured OTLP backend. The other OTLPMetrics Writer will remain in standby mode and ready to take
