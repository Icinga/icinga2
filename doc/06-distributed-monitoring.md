...
!!! warning
    ...
    Icinga isn't aware of intermediate CA(s) as such and won't serve them as part of the chain.
    TLS clients won't see an uninterrupted chain from your root CA to Icinga leaf certificates!
