...
Here is an overview of all parameters in detail:
  ...
  Replay log duration | **Optional.** Allows to specify the replay log duration in seconds for the local and parent endpoints. For agent setups, this is intentionally disabled. For master/satellite setups, specify a value of 3600 (1h) or higher depending on the expected downtime windows.
