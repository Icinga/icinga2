...
`BOOST_LIBRARYDIR`    | Binary: `C:\local\boost_1_78_0\lib64-msvc-14.1`, Source: `C:\local\boost_1_78_0\stage` | Path to the static compiled Boost libraries, directory must contain `lib`.
