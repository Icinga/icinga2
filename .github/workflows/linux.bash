...
case "$DISTRO" in
  ...
  amazonlinux:2)
    ...
    wget https://archives.boost.io/release/1.76.0/source/boost_1_76_0.tar.bz2
    ...
    CMAKE_OPTS+=(-DBOOST_{INCLUDEDIR=/boost_1_76_0,LIBRARYDIR=/boost_1_76_0/stage/lib})
    CMAKE_OPTS+=(-DCMAKE_CXX_COMPILER=gcc10-g++ -DCMAKE_C_COMPILER=gcc10-gcc)

    export LD_LIBRARY_PATH=/boost_1_76_0/stage/lib
    ;;
