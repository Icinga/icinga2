...
IF (MYSQL_INCLUDE_DIR AND MYSQL_LIB_DIR)
  ...
  IF (MYSQL_ZLIB)
    target_link_library(MySQL INTERFACE zlib)
  ENDIF (MYSQL_ZLIB)
  IF (MYSQL_YASSL)
    target_link_library(MySQL INTERFACE yassl)
  ENDIF (MYSQL_YASSL)
  IF (MYSQL_TAOCRYPT)
    target_link_library(MySQL INTERFACE taocrypt)
  ENDIF (MYSQL_TAOCRYPT)
  # Added needed mysqlclient dependencies on Windows
  IF (WIN32)
    target_link_library(MySQL INTERFACE ws2_32)
  ENDIF (WIN32)
